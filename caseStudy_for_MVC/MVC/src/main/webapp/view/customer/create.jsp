        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" action="/customer?action=create"
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="customerName" class="form-control" placeholder="Input name" name="customerName">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="d-flex">
                    <label class="d-block me-4">
                        <input type="radio" value="1" name="customerGender"> Male
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="customerIdCard" class="form-control" placeholder="Input Id card" name="customerIdCard">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="customerPhone" class="form-control" placeholder="Input Phone number" name="customerPhone">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="customerEmail" class="form-control" placeholder="Input Email" name="customerEmail">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="customerAddress" class="form-control" placeholder="Input Address" name="customerAddress">

...
public class attachFacility {
    ...
    String attachFacilityName;
    double attachFacilityCost;
    String attachFacilityUnit;
    String attachFacilityStatus;

    public attachFacility() {
    }

    public attachFacility(int attachFacilityId, String attachFacilityName, double attachFacilityCost, String attachFacilityUnit, String attachFacilityStatus) {

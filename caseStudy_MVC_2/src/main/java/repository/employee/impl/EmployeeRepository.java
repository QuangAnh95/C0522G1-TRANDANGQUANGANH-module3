...
public class EmployeeRepository implements IEmployeeRepository {
    ...
    private static final String INSERT = "insert into employee(employee_name, employee_birthday, employee_id_card, employee_salary, employee_phone, employee_email," +
    ...
    public boolean create(Employee employee) {
        ...
        try {
            ...
            int cre = preparedStatement.executeUpdate();
            return (cre == 1);
        } catch (SQLException e) {
            e.printStackTrace();
        }

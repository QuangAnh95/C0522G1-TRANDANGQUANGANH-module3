...
public class AttachFacility {
    ...
    public AttachFacility(String attachFacilityName, double attachServiceCost, String attachServiceUnit, String attachServiceStatus) {
    ...
    public AttachFacility(int attachFacilityId, String attachFacilityName, double attachServiceCost, String attachServiceUnit, String attachServiceStatus) {

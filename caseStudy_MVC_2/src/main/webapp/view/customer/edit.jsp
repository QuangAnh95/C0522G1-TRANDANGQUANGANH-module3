    ...
    <div class="d-flex justify-content-center">
        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" method="post">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="name" class="form-control" name="customerName" value="${customer.customerName}">
                    <span class="input-group-text"> <i class="fa-solid fa-person-circle-question"></i></span>
                </div>
            </div>
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="phone" class="form-control" name="customerPhone" value="${customer.customerPhone}">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="email" class="form-control" name="customerEmail" value="${customer.customerEmail}">
